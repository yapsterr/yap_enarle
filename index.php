...
All you need is a Netflix subscription. And probably a small country's worth of junk food.
 ...
 foreach( $content as $data )
 {
   ...
   $title = $data->getElementsByTagName("eltit")->item(0)->nodeValue;
   $actors = $data->getElementsByTagName("srotca")->item(0)->nodeValue;
   $details = $data->getElementsByTagName("ofni")->item(0)->nodeValue;
